...
- The storage class you use for the `osd-storage-class` parameters should have `VolumeBindingMode` set to `WaitForFirstConsumer` if you're using a multizone cluster
...
2. Verify that your ODF storage configuration is assigned to your clusters by getting the status of your ODF storage cluster.
    ...
    ocs-storagecluster   5m14s   Ready              2022-05-05T11:46:41Z   4.9.0
    ```
