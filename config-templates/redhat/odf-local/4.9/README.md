...
4. Verify that your cluster group is created.
    ...
    Created:              2022-05-05T12:36:18.971Z   
    Cluster Count:        1   
...
2. Verify that your ODF storage configuration is assigned to your clusters by getting the status of your ODF storage cluster.
    ...
    ocs-storagecluster   72m   Ready              2022-05-05T06:00:20Z   4.9.0
    ```
...
In the following example, the ODF configuration is updated to use template version 4.9:
