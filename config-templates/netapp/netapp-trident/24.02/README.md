...
```sh
ibmcloud sat storage config create --name "trident-conf" --location <location id> --template-name "netapp-trident" --template-version "22.10"
```
...
- [ONTAP NAS backend configuration](https://docs.netapp.com/us-en/trident/trident-use/ontap-nas-prep.html)
- [ONTAP SAN backend configuration](https://docs.netapp.com/us-en/trident/trident-use/ontap-san-prep.html)
- [Support documentation](https://docs.netapp.com/us-en/trident/get-help.html#astra-trident-support-lifecycle)
